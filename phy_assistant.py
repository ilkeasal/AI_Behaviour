...
if st.session_state.start_experiment =="consent":
   st.markdown("""Welcome, and thank you for participating in this experiment. This experiment is part of a research project conducted by the AI & Behaviour group at the Vrije Universiteit Amsterdam. It involves interacting with a chatbot in a conversation focused on physical activity. It consists of three parts. In the first part, you will answer a few brief questions about yourself, such as demographics, prior chatbot experience, physical activity levels, and motivation to be physically active. This part will take about 2-3 minutes to complete.\n
