...
if st.session_state.start_experiment =="consent":
    ...
    Please be aware that while your conversation with the chatbot will be saved for research purposes, your privacy is our priority. The conversation will not be linked to your identity. Instead, you will be assigned a
    randomly generated ID, and all data will be associated with this ID only. We want to ensure that you feel comfortable throughout the process. The information collected will be used solely for the purpose of this study.\n
    """)
