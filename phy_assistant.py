...
As the main phase of this experiment, the second part involves a conversation with our chatbot, which is expected to last around 15 minutes. During the conversation, a ‘Stop the conversation’ button will appear at a certain point, giving you the option to end the conversation. Clicking this button will take you to the final part of the experiment, consisting of post-survey questions, which will take approximately 2-3 minutes to complete. If you wish to continue the conversation, no action is required-simply keep interacting with the chatbot. The ‘Stop the conversation’ button will become available at specific times, allowing you to stop the conversation later if you choose. If the button is not clicked, the conversation will continue indefinitely.\n

While interacting with the chatbot, you will notice the word ‘Running’ displayed in the top-right corner after you provide an input. This indicates that the chatbot is processing your input. The ‘Running’ indicator will disappear once the chatbot has completed its response. Please wait for the chatbot to finish generating its output before entering a new input. You will also see the ‘Running’ indicator during the first and final parts of the experiment when answering questions. Ensure that you wait for the ‘Running’ indicator to disappear before proceeding to the next question. After completing the final question and the ‘Running’ indicator disappears, you may click the ‘Submit’ button.\n

When conversing with the chatbot, after giving an input, before the chatbot gives you a complete output, you will see the word ‘Running’ in the top right corner. This will disappear once the output of the chatbot is complete. Please wait for the chatbot to finalize its output before entering a new input. You will see this ‘Running’ indicator in the first and the final parts of the experiment, when you answer the questions. Please wait for the ‘Running’ indicator to disappear, before moving on the next question. Once you complete the last question, and the ‘Running’ indicator disappears, you can click the ‘Submit’ button.\n 
