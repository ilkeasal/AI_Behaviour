...
if st.session_state.start_experiment =="consent":
   ...
   When answering the questions in both the first and the final parts of the experiment, you will see the word 'Running' in the top right corner after entering your answer. Please wait for this to finish before moving on to the next question. Once you have completed all the questions, click the 'Submit' button to proceed to the next part.\n
   Please also wait for the chatbot's response during the conversation in the second part of the experiment while 'Running' indicator is active. Once the chatbot responds, you can continue the conversation. Please be aware that while your conversation with the chatbot will be saved for research purposes, your privacy is our priority. The conversation will not be linked to your identity. Instead, you will be assigned a randomly generated ID, and all data will be associated with this ID only. We want to ensure that you feel comfortable throughout the process. The information collected will be used solely for the purpose of this study.\n
   """)
